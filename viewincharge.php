...
<br>
<br>
             <h2 align="center">Incharge Details</h2>
...
<br>
 ...
 ?>
	<tr>
        ...
        <td bgcolor=white><font color=black size=2><a href="inchrgeupdate.php?select=<?php echo $row['id'];?>">Update</a></font></td>
...
if(isset($_GET['delete']))
	...
	$query = "delete from sprtsin where id='".$_GET['delete']."'";
	mysql_query($query);

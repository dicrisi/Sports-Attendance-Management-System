...
$query2 = "select * from sprtsin where id='".$_GET['select']."'";
			//echo $query2;
...
<br>
<br>
<center><font color="black" size="8">Incharge Update Details </font></center>
</br>
...
if(isset($_POST['submit'])){
	...
	$query = "update sprtsin set id='".$_POST['id']."', name='".$_POST['name']."', usermail='".$_POST['usermail']."', password='".$_POST['password']."', Address='".$_POST['address']."',  Mobile='".$_POST['mobile']."'  where id= '".$_GET['select']."'";
	echo $query;
	...
	header("location:viewincharge.php");
	exit;
//}
 }
